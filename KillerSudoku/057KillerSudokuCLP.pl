...
cages([
    ...
    cage(4,  [pos(1,7), pos(1,8)]),
    cage(15, [pos(1,9), pos(2,9), pos(3,9)]),
    cage(25, [pos(2,1), pos(3,1), pos(4,1)]),
    cage(17, [pos(2,3), pos(2,4), pos(2,5)]),
    cage(9,  [pos(3,3), pos(3,4)]),
    cage(8,  [pos(3,6), pos(3,7)]),
    cage(6,  [pos(4,1), pos(5,1)]),
    cage(14, [pos(4,2), pos(5,2), pos(5,3)]),
    cage(17, [pos(4,5), pos(4,6), pos(5,6)]),
    cage(17, [pos(4,8), pos(4,9), pos(5,9)]),
    cage(20, [pos(5,4), pos(5,5), pos(6,5)]),
    cage(12, [pos(5,9), pos(6,9)]),
    cage(27, [pos(6,1), pos(7,1), pos(8,1)]),
    cage(6,  [pos(6,3), pos(6,4)]),
    cage(20, [pos(6,6), pos(7,6), pos(7,5)]),
    cage(6,  [pos(6,7), pos(7,7)]),
    cage(10, [pos(7,5), pos(7,4), pos(7,3)]),
    cage(14, [pos(7,8), pos(7,9)]),
    cage(8,  [pos(8,2), pos(8,3)]),
    cage(15, [pos(8,6), pos(8,7)]),
    cage(13, [pos(9,5), pos(9,6)]),
